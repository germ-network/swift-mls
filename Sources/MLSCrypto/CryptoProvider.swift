...
extension MLS {
    ...
    public protocol CipherSuiteProvider: Sendable {
        ...
        func verify(publicKey: SignaturePublicKey, content: Data, signature: Data) throws -> Bool
        ...
        func hpkeSeal(publicKey: HpkePublicKey, info: Data, aad: Data?, plaintext: Data) throws -> (enc: Data, ciphertext: Data)
        func hpkeOpen(enc: Data, secretKey: HpkeSecretKey, info: Data, aad: Data?, ciphertext: Data) throws -> Data
    }
